...
const portfolioData = {
  socials: [
    ...
    { name: "GitHub", url: "https://github.com/naga251602", icon: "github" },
    { name: "Email", url: "mailto:nagalapu@usc.edu", icon: "mail" },
  ],
  education: [
    {
      ...
      details:
        "<strong>Relevant Coursework:</strong><br>Advanced Algorithms, Cloud Computing, Database Systems, Machine Learning, Web Technologies.<br><br><strong>Clubs & Societies:</strong><br>USC Viterbi Graduate Student Association, ACM Chapter Member.",
    },
    {
      // Secondary education for Modal
      school: "R.M.K. Engineering College, Anna University",
      years: "Aug 2020 - Apr 2024",
      degree: "B.Tech Information Technology",
      details:
        "Graduated with Distinction. Lead of Google DSC. Built multiple full-stack projects and organized 3 hackathons.",
    },
  ],
  stats: [
  ...
  experience: [
    {
      ...
      desc: [
        "Reduced page render time from 3.2s to 800ms for 500+ vehicle listings using React virtualization and lazy loading, improving engagement by 25%.",
        "Replaced O(n) inventory updates with deque-based O(1) queue operations, eliminating 200ms UI lag.",
        "Optimized CSV batch processing via merge sort and multithreading, reducing import time by 35% (12 min to 7.8 min).",
      ],
    },
    {
      ...
      location: "Hybrid",
      desc: [
        "Owned software development lifecycle for three ML-integrated applications using Python, Scikit-learn, and TensorFlow.",
        "Built backend pipelines for data ingestion and preprocessing leading to three co-authored conference papers.",
      ],
    },
    {
      role: "Intern",
      ...
      location: "Chennai, India",
      desc: [
        "Gained hands-on experience in software development lifecycle and enterprise application architecture.",
        "Collaborated with senior developers on backend optimization tasks.",
      ],
    },
    {
      role: "Frontend Team Lead & Intern",
      company: "Sawbon",
      date: "Jan 2022 – Feb 2022",
      location: "Remote",
      desc: [
        "Built responsive rental UI with React and Tailwind, reducing API calls by 40% and improving responsiveness by 20%.",
        "Migrated session management to Redis, enabling 2x concurrent users and reducing database queries by 30%.",
      ],
    },
    {
      ...
      location: "Remote",
      desc: [
        "Completed rigorous 2-week coding bootcamp focusing on advanced JavaScript patterns.",
        "Built 3 projects: Entertainment portal, Blogging platform, and Quiz app.",
      ],
    },
  ],
  projects: [
    {
      ...
      tagline: "Unsupervised Detection",
      date: "2025",
      icon: "shield-alert",
      color: "blue",
      desc: "Built an unsupervised AIOps system correlating metrics, logs, and traces to detect silent microservice failures, reducing simulated MTTD by 40%. Designed a Spark-based ETL pipeline to clean and align noisy observability data without label leakage.",
      tags: ["Python", "Spark", "PyTorch", "Docker"],
      features: [
        "Correlates metrics, logs, and traces",
        "Reduces simulated MTTD by ~40%",
        "Spark-based ETL pipeline",
        "Autoencoder anomaly detection producing 1 alert per 100+ windows",
      ],
      links: {
        demo: "#",
    ...
    {
      id: "AIStora",
      title: "AIStora AI Analytics",
      tagline: "NLP Data Platform",
      date: "2024",
      icon: "database",
      color: "purple",
      desc: "Enabled natural-language CSV querying, reducing report generation from 2 hours to 5 minutes using a custom engine processing 100K+ rows at 3x Pandas speed. Built Flask REST APIs with JWT authentication and PostgreSQL.",
      tags: ["Python", "Flask", "PostgreSQL", "Docker", "NLP"],
      features: [
        "Natural-language CSV querying",
        "Custom engine 3x faster than Pandas",
        "JWT Authentication",
        "CI/CD Pipeline",
      ],
      links: { demo: "#", code: "https://github.com/naga251602/aistora" },
      codeSnippet: `@app.route('/query', methods=['POST'])\ndef query_data():\n    user_query = request.json.get('query')\n    # Convert NL to SQL/Pandas ops\n    result = engine.process(user_query)\n    return jsonify(result)`,
      images: ["./resources/demo.gif"],
    },
    {
      id: "GraphQLAPI",
      title: "Task Mgmt API",
      tagline: "GraphQL Backend",
      date: "2023",
      icon: "server",
      color: "green",
      desc: "Designed GraphQL API reducing payload size by 60% and latency from 200ms to 80ms with Redis caching. Implemented OAuth 2.0, rate-limiting, and load-tested to support 1000+ concurrent users.",
      tags: ["GraphQL", "Node.js", "Redis", "OAuth 2.0"],
      features: [
        "Reduced payload size by 60%",
        "Redis Caching (80ms latency)",
        "OAuth 2.0 Security",
        "Rate Limiting",
      ],
      links: { demo: "#", code: "https://github.com/naga251602/todo-graphql" },
      codeSnippet: `const typeDefs = gql\`\n  type Task {\n    id: ID!\n    title: String!\n    completed: Boolean!\n  }\n  type Query {\n    tasks: [Task]\n  }\n\`;`,
    },
  ],
  publications: [
    {
    ...
    },
    {
      ...
      color: "purple",
      citation:
        'Gaurav N V, et al. "Brain Tumor Detection Using Convolutional Neural Networks," 14th International Conference on Computer Communication and Informatics (ICCCI), Coimbatore, India, Jan 2024.',
      notes: [
        {
          label: "Focus",
          text: "Automated tumor detection in MRI scans using deep CNN architectures.",
        },
        {
          label: "Result",
          text: "Achieved high accuracy in binary classification of tumor presence.",
        },
      ],
      link: "#",
      tags: ["CV", "Python", "Deep Learning"],
    },
  ],
  oss: [
    {
